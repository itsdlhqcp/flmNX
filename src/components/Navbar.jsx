...
const Navbar = () => {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-10 bg-gray-200 ">
      <div className="flex items-center justify-between px-6 md:px-[200px] py-4">
        <h1 className="text-lg font-extrabold md:text-xl"><Link to="/">FILM NEWS</Link></h1>
        <div className="flex items-center justify-center space-x-2">
      ...
      <div className="flex items-center justify-between px-14 md:px-[200px] py-1 bg-orange-300">
      <h1 className="text-lg font-extrabold md:text-xl">
        <Link to="/" className="hover:text-green-700">NEWS</Link>
      </h1>
      <h1 className="text-lg font-extrabold md:text-xl">
        <span className="text-stone-500">|</span>
      </h1>
      <h1 className="text-lg font-extrabold md:text-xl">
        <Link to="/otts" className="hover:text-green-600">OTT</Link>
      </h1>
      <h1 className="text-lg font-extrabold md:text-xl">
        <span className="text-stone-500">|</span>
      </h1>
      <h1 className="text-lg font-extrabold md:text-xl">
        <Link to="/release" className="hover:text-green-700">RELEASE</Link>
      </h1>
    </div>
    </div>
